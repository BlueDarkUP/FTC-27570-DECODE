...
public class Blue18 extends OpMode {
    ...
    private final double NormalShootingPower = 2658.0;
    ...
    public void buildPaths() {
        ...
        Path4 = follower.pathBuilder().addPath(new BezierCurve(new Pose(14.500, 66), new Pose(55, 77))).setLinearHeadingInterpolation(Math.toRadians(180), Math.toRadians(-52.5)).build();
        Path5 = follower.pathBuilder().addPath(new BezierCurve(new Pose(55, 77), new Pose(40.000, 25.000),new Pose(12.3, 61))).setLinearHeadingInterpolation(Math.toRadians(-52.5), Math.toRadians(160)).build();
        Path6 = follower.pathBuilder().addPath(new BezierCurve(new Pose(12.3, 61), new Pose(55, 77))).setLinearHeadingInterpolation(Math.toRadians(160), Math.toRadians(-52.5)).build();
        Path7 = follower.pathBuilder().addPath(new BezierLine(new Pose(55, 77), new Pose(46.602, 86.5))).setLinearHeadingInterpolation(Math.toRadians(-52.5), Math.toRadians(180)).build();
        ...
        Path9 = follower.pathBuilder().addPath(new BezierLine(new Pose(24.000, 86.5), new Pose(55, 77))).setLinearHeadingInterpolation(Math.toRadians(180), Math.toRadians(-52.5)).build();
        Path10 = follower.pathBuilder().addPath(new BezierLine(new Pose(55, 77), new Pose(43.107, 44))).setLinearHeadingInterpolation(Math.toRadians(-52.5), Math.toRadians(180)).build();
        ...
        Path12 = follower.pathBuilder().addPath(new BezierLine(new Pose(17, 44), new Pose(55, 77))).setLinearHeadingInterpolation(Math.toRadians(180), Math.toRadians(-52.5)).build();
        Path13 = follower.pathBuilder().addPath(new BezierLine(new Pose(55, 77), new Pose(57.553, 56.388))).setLinearHeadingInterpolation(Math.toRadians(-52.5), Math.toRadians(180)).build();
    }
}